...
`__PRODUCT_NAME__` is an independent Digital Ghana public-infrastructure product. Its canonical public home is `https://__PRODUCT_HOSTNAME__` after production evidence supports a lifecycle transition.
